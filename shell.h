...
typedef struct {
    command_node_t *head;          /* First command in chain */
    command_node_t *tail;          /* Last command in chain */
...
command_node_t* create_command_node(void);
void add_command_to_chain(command_chain_t *chain, command_node_t *node);
